...
print('\nIf and adventurer returns from a succesful quest and buys each of')
print('6 companions 3 bottles of ale, how many bottles are purchased?')
input('Press the enter key to find out.' '\n')
print(6 * 3)

print('\nIf a resturant check comes to 19 dollars with tip, and you and')
...
print('\nIf thats same group of 4 pirates evenly divides the chest full')
